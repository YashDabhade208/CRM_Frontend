...
const UserDashboard = () => {
    ...
    return (<body class="relative bg-yellow-50 overflow-hidden max-h-screen">
                ...
                <div class="max-w-4xl mx-auto">
                    <div class="bg-white rounded-3xl p-8 mb-5">
                        ...
                        <div class="grid grid-cols-2 gap-x-20">
                            ...
                            <div>
                                <h2 class="text-2xl font-bold mb-4">Your Upcoming Appointmnets</h2>

                                <div class="space-y-4">
                                   {appointments.map((appoint,index)=>( <div class="p-4 bg-white border rounded-xl text-gray-800 space-y-2">
                                        <div class="flex justify-between">
                                            <div class="text-gray-400 text-xs">Patient Id:{appoint.patient_id}</div>
                                            <div class="text-gray-400 text-xs">Appointment Time:{  appoint.appointment_time}</div>
                                        </div>
                                            {}
